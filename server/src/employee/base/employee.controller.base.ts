...
export class EmployeeControllerBase {
  ...
  async findManyAssignedRoutes(
    @common.Req() request: Request,
    @common.Param() params: EmployeeWhereUniqueInput
  ): Promise<Route[]> {
    const query = plainToClass(RouteFindManyArgs, request.query);
    const results = await this.service.findAssignedRoutes(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/assignedRoutes")
  @nestAccessControl.UseRoles({
    resource: "Employee",
    action: "update",
    possession: "any",
  })
  async connectAssignedRoutes(
    @common.Param() params: EmployeeWhereUniqueInput,
  ...
  @common.Patch("/:id/assignedRoutes")
  @nestAccessControl.UseRoles({
    resource: "Employee",
    action: "update",
    possession: "any",
  })
  async updateAssignedRoutes(
    @common.Param() params: EmployeeWhereUniqueInput,
    @common.Body() body: RouteWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/assignedRoutes")
  @nestAccessControl.UseRoles({
    resource: "Employee",
    action: "update",
    possession: "any",
  })
  async disconnectAssignedRoutes(
    @common.Param() params: EmployeeWhereUniqueInput,
    @common.Body() body: RouteWhereUniqueInput[]
  ): Promise<void> {
    const data = {
